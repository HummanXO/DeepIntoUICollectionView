...
struct TopicSubmissions: Codable {
    let fashionBeauty, people: ArchitectureInterior?
    let film: Film?
    let architectureInterior, wallpapers, travel: ArchitectureInterior?
    let spirituality: Film?
    let nature, experimental, sports: ArchitectureInterior?
    let streetPhotography: Film?
...
typealias WelcomeDTO = [WelcomeElement]
